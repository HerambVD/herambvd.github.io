    ...
    <div className="dark:text-white dark:bg-gray-900">
      <div className="container mx-auto grid grid-cols-1 px-5 md:px-20 pt-20">
        ...
        <div className="shadow p-5 bg-gray-50 dark:bg-gray-800">
          <h2 className="text-2xl mb-4">Privacy policy for Heramb</h2>
          <p>
            At Heramb, the privacy of our visitors is of utmost importance
            to us. This privacy policy outlines the types of personal
            information that is received and collected by Heramb and how
            it is used.
          </p>
        </div>
